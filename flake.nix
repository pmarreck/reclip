      ...
      in
      {
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            ...
            cp -r app.py cli.py config.py cache.py llm_client.py service.py media_extractor.py actions.py diarizer.py speakers.py paragraphize.py templates static assets $out/share/reclip/
